            ...
            try:
                ...
                try:
                  ...
                  #  print(image_name+"::::->",data,"image_url:::->",image_url)
                    ...
                    image_urlList.append(str(image_url).lower())
                    output_file.close()
    ...
    for file in files:
        try:
           ...
           # print("image Name::->", file.title())
            ...
            new_string = (my_new_string.split('.')[1]).lower()
            res = [i for i in image_urlList if new_string in i ]
            print(new_string,"::::->",res,"::::->",text)
            query = {"url": str(res)}
